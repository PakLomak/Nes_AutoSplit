state("qFceux", "2.6.4")
{
byte start: "qfceux.exe", 0x0318340, 0xE9;
...
state("Mesen", "0.9.9")
{
byte start: "MesenCore.dll", 0x42E0F30, 0xB8, 0x58, 0xE9;
...
state("Mesen", "2.0.0")
{
byte start: "MesenCore.dll", 0x440EF98, 0x4A0, 0xE9;
...
{
byte start: "mednafen.exe", 0x136E7E9;
...
{
byte start: "mednafen.exe", 0x1667629;
...
state("Nestopia", "1.40")
{
byte start: "nestopia.exe", 0x1B2BCC, 0x00, 0x08, 0x0C, 0x0C, 0x151;
...
start
{
	if (old.start !=0x02 && current.start ==0x02) return true;
}
split
{
