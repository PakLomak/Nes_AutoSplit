...
byte split: "fceux64.exe", 0x04D59E0, 0x44;
}
state("Mesen", "0.9.9")
{
...
byte split: "MesenCore.dll", 0x42FA9C0, 0xB8, 0x58, 0x44;
}
state("Mesen", "2.0.0")
{
...
byte split: "nestopia.exe", 0x0178020, 0xA0, 0xB18, 0xA1C, 0xA10, 0xA04, 0xAC4, 0x44;
}
state("Retroarch", "Mesen")
{
byte start: "retroarch.exe", 0x0E88F38, 0x408, 0x3A;
byte reset: "retroarch.exe", 0x0E88F38, 0x408, 0x14;
byte split: "retroarch.exe", 0x0E88F38, 0x408, 0x44;
}
