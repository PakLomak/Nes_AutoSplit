...
start
{
    return (current.stage == 0x01 && current.start == 0x01 && current.start2 == 0x01 || current.stage == 0x01 && current.start == 0x02 && current.start2 == 0x02);
}
split
{
    if (old.cage == 0x00 && current.cage == 0x01) return(true);
}
reset
{
    return (current.reset == 0xCC && current.stage == 0x01);
}
startup
{
