state("Fceux64", "2.6.6")
{
byte start: "fceux64.exe", 0x04D59E0, 0xDC;
byte level: "fceux64.exe", 0x04D59E0, 0x47;
byte end: "fceux64.exe", 0x04D59E0, 0x39;
}
state("Mesen", "0.9.9")
{
...
state("Mesen", "0.0.6")
{
byte start: "MesenCore.dll", 0x42FA9C0, 0xB8, 0x58, 0xDC;
byte level: "MesenCore.dll", 0x42FA9C0, 0xB8, 0x58, 0x47;
byte end: "MesenCore.dll", 0x42FA9C0, 0xB8, 0x58, 0x39;
}
state("Mesen", "2.0.0")
{
...
state("Nestopia", "1.52")
{
byte start: "nestopia.exe", 0x0178020, 0xA0, 0xB18, 0xA1C, 0xA10, 0xA04, 0xAC4, 0xDC;
byte level: "nestopia.exe", 0x0178020, 0xA0, 0xB18, 0xA1C, 0xA10, 0xA04, 0xAC4, 0x47;
byte end: "nestopia.exe", 0x0178020, 0xA0, 0xB18, 0xA1C, 0xA10, 0xA04, 0xAC4, 0x39;
}
state("Retroarch", "Mesen")
{
byte start: "retroarch.exe", 0x0E88F38, 0x408, 0xDC;
byte level: "retroarch.exe", 0x0E88F38, 0x408, 0x47;
byte end: "retroarch.exe", 0x0E88F38, 0x408, 0x39;
}
init
{
