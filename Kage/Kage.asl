state("Fceux64", "2.6.6")
{
byte start: "fceux64.exe", 0x04D59E0, 0xB4;
byte input: "fceux64.exe", 0x04D59E0, 0x6;
byte number: "fceux64.exe", 0x04D59E0, 0x2;
byte level: "fceux64.exe", 0x04D59E0, 0x40;
byte hp: "fceux64.exe", 0x04D59E0, 0x7F8;
byte boss: "fceux64.exe", 0x04D59E0, 0x7F9;
}
state("Mesen", "0.9.9")
{
...
state("Mesen", "0.0.6")
{
byte start: "MesenCore.dll", 0x42FA9C0, 0xB8, 0x58, 0xB4;
byte input: "MesenCore.dll", 0x42FA9C0, 0xB8, 0x58, 0x6;
byte number: "MesenCore.dll", 0x42FA9C0, 0xB8, 0x58, 0x2;
byte level: "MesenCore.dll", 0x42FA9C0, 0xB8, 0x58, 0x40;
byte hp: "MesenCore.dll", 0x42FA9C0, 0xB8, 0x58, 0x7F8;
byte boss: "MesenCore.dll", 0x42FA9C0, 0xB8, 0x58, 0x7F9;
}
state("Mesen", "2.0.0")
{
...
state("Nestopia", "1.52")
{
byte start: "nestopia.exe", 0x0178020, 0xA0, 0xB18, 0xA1C, 0xA10, 0xA04, 0xAC4, 0xB4;
byte input: "nestopia.exe", 0x0178020, 0xA0, 0xB18, 0xA1C, 0xA10, 0xA04, 0xAC4, 0x6;
byte number: "nestopia.exe", 0x0178020, 0xA0, 0xB18, 0xA1C, 0xA10, 0xA04, 0xAC4, 0x2;
byte level: "nestopia.exe", 0x0178020, 0xA0, 0xB18, 0xA1C, 0xA10, 0xA04, 0xAC4, 0x40;
byte hp: "nestopia.exe", 0x0178020, 0xA0, 0xB18, 0xA1C, 0xA10, 0xA04, 0xAC4, 0x7F8;
byte boss: "nestopia.exe", 0x0178020, 0xA0, 0xB18, 0xA1C, 0xA10, 0xA04, 0xAC4, 0x7F9;
}
state("Retroarch", "Mesen")
{
byte start: "retroarch.exe", 0x0E88F38, 0x408, 0xB4;
byte input: "retroarch.exe", 0x0E88F38, 0x408, 0x6;
byte number: "retroarch.exe", 0x0E88F38, 0x408, 0x2;
byte level: "retroarch.exe", 0x0E88F38, 0x408, 0x40;
byte hp: "retroarch.exe", 0x0E88F38, 0x408, 0x7F8;
byte boss: "retroarch.exe", 0x0E88F38, 0x408, 0x7F9;
}
init
{
