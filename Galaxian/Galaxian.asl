state("Fceux64", "2.6.6")
{
byte start: "fceux64.exe", 0x04D59E0, 0x4F;
byte score: "fceux64.exe", 0x04D59E0, 0x119;
byte reset: "fceux64.exe", 0x04D59E0, 0x75;
}
state("Mesen", "0.9.9")
{
...
state("Mesen", "0.0.6")
{
byte start: "MesenCore.dll", 0x42FA9C0, 0xB8, 0x58, 0x4F;
byte score: "MesenCore.dll", 0x42FA9C0, 0xB8, 0x58, 0x119;
byte reset: "MesenCore.dll", 0x42FA9C0, 0xB8, 0x58, 0x75;
}
state("Mesen", "2.0.0")
{
...
state("Nestopia", "1.52")
{
byte start: "nestopia.exe", 0x0178020, 0xA0, 0xB18, 0xA1C, 0xA10, 0xA04, 0xAC4, 0x4F;
byte score: "nestopia.exe", 0x0178020, 0xA0, 0xB18, 0xA1C, 0xA10, 0xA04, 0xAC4, 0x119;
byte reset: "nestopia.exe", 0x0178020, 0xA0, 0xB18, 0xA1C, 0xA10, 0xA04, 0xAC4, 0x75;
}
state("Retroarch", "Mesen")
{
byte start: "retroarch.exe", 0x0E88F38, 0x408, 0x4F;
byte score: "retroarch.exe", 0x0E88F38, 0x408, 0x119;
byte reset: "retroarch.exe", 0x0E88F38, 0x408, 0x75;
}
init
{
...
split
{
	if (old.score == 0x04 && current.score >= 0x05) return true;
}
reset
{
