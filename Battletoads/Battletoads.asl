...
byte pauseComplete: "fceux64.exe", 0x04D59E0, 0xEB;
byte BikeGlitch: "fceux64.exe", 0x04D59E0, 0x650;
...
byte pauseComplete: "MesenCore.dll", 0x42FA9C0, 0xB8, 0x58, 0xEB;
byte BikeGlitch: "MesenCore.dll", 0x42FA9C0, 0xB8, 0x58, 0x650;
...
byte pauseComplete: "mednafen.exe", 0x136E7EB;
byte BikeGlitch: "mednafen.exe", 0x136ED50;
